...
![Nasi Goreng mit veganen Filetstücken](hero.jpg)
...
| **Diät** | vegan |
| **Cookidoo-Rezept (privat, eingeloggt)** | https://cookidoo.de/created-recipes/de-DE/01KRQ1JCX58H8QGDSBB47XVP5B |
| **Cookidoo-Rezept (öffentlich)** | https://cookidoo.de/created-recipes/public/recipes/de-DE/01KRQ1JCX58H8QGDSBB47XVP5B |
| **Original HelloFresh-Rezept** | https://www.hellofresh.de/recipes/nasi-goreng-mit-veganen-filetstucken-64e461d2e1f123211ed56789 |
...
![Public Preview ohne Login](../../docs/assets/nasi-public-preview.png)

Die Zubereitung mit den hervorgehobenen Koch-Befehlen (im View nur für eingeloggte Cookidoo-Nutzer):

![Zubereitung mit Chips](../../docs/assets/nasi-zubereitung.png)

Tipps + Quellen-Narrativ als eigene Sektion unterhalb der Schritte:

![Tipps mit Narrativ](../../docs/assets/nasi-tips.png)

## Quelle & Lizenz

Original-Rezept stammt aus der HelloFresh-Wochenbox („Nasi Goreng mit veganen Filetstücken", Variante „Thermomix"). Die Anpassung (Step-Reihenfolge, Native-Verben, Mengen-Konsistenz, Thermomix-Würzpaste statt Pürierstab, Tipps) ist die Eigenarbeit für die Cookidoo-Version.
