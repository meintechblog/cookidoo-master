...
![Räuchertofu Gyros-Art mit Kartoffelsalat und Zaziki](hero.jpg)

## Kennzahlen

| | |
|---|---|
| **Quelle** | HelloFresh Wochenbox, Karte #25 (HF_Y24_R33_W02, vegan) |
| **Portionen** | 4 |
| **Arbeitszeit** | ca. 30 Min. |
| **Gesamtzeit** | ca. 40 Min. |
| **Schwierigkeit** | einfach |
| **Diät** | vegan |
| **Cookidoo-Rezept (privat, eingeloggt)** | https://cookidoo.de/created-recipes/de-DE/01KSMJK60SXV36SCX77T7N5ZV6 |
| **Cookidoo-Rezept (öffentlich)** | https://cookidoo.de/created-recipes/public/recipes/de-DE/01KSMJK60SXV36SCX77T7N5ZV6 |
| **Original HelloFresh-Rezept** | https://www.hellofresh.de/recipes/souflaki-rauchertofu-mit-kartoffelsalat-and-zaziki-64e860a94e40d5c6cb1a53fe |
...
![Public Preview ohne Login](../../docs/assets/gyros-public-preview.png)

Die Zubereitung mit den hervorgehobenen Koch-Befehlen:

![Zubereitung mit Chips](../../docs/assets/gyros-zubereitung.png)

Tipps + Quellen-Narrativ:

![Tipps mit Narrativ](../../docs/assets/gyros-tips.png)

## Quelle & Lizenz

Original-Rezept stammt aus der HelloFresh-Wochenbox („Souflaki-Räuchertofu mit Kartoffelsalat & Zaziki", Karte #25, vegan). Die Anpassung (Mixtopf-Zaziki, Kräuter-Oliven-Hack-Step, Mengen-Konsistenz, Tipps) ist die Eigenarbeit für die Cookidoo-Version.
