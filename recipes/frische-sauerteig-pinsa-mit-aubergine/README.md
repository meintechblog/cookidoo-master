...
![Frische Sauerteig-Pinsa mit Aubergine](hero.jpg)
...
| **Diät** | vegan |
| **Cookidoo-Rezept (privat, eingeloggt)** | https://cookidoo.de/created-recipes/de-DE/01KRQ44JTZ8ETRE7N6PBB4Q0Q8 |
| **Cookidoo-Rezept (öffentlich)** | https://cookidoo.de/created-recipes/public/recipes/de-DE/01KRQ44JTZ8ETRE7N6PBB4Q0Q8 |
| **Original HelloFresh-Rezept** | https://www.hellofresh.de/recipes/frische-sauerteig-pinsa-mit-aubergine-6978d31f6aaab04ab65108b0 |
| **Foto** | © Jörg Hofmann (eigene Aufnahme) |

## Zutaten (4P)

- 520 g frischer Sauerteig-Pinsateig
- 2 Auberginen
...
- 50 g Tomatenpesto
- 17 g süßer Senf
- 12 g Gewürzmischung „Hello Buon Appetito"
...
Die HelloFresh-Kreationen sind grandios — frisch, kreativ, jede Woche was Neues in der Box. Schade nur, dass die als „Thermomix-Variante" gelabelten Karten das Gerät bisher kaum nutzen.

Für diese Cookidoo-Version habe ich:

- **Die Tomatensoße in den Mixtopf gepackt** (statt nur mit dem Löffel zu verrühren) — die kurze Pürier-Aktion gibt eine homogene streichfähige Paste, perfekt für die Pinsa-Basis.
...
![Public Preview ohne Login](../../docs/assets/pinsa-public-preview.png)

Die Zubereitung mit dem hervorgehobenen Koch-Befehl:

![Zubereitung mit Chip](../../docs/assets/pinsa-zubereitung.png)

Tipps + Quellen-Narrativ:

![Tipps mit Narrativ](../../docs/assets/pinsa-tips.png)

## Quelle & Lizenz

Original-Rezept stammt aus der HelloFresh-Wochenbox („Flammkuchen mit Aubergine und Paprika", Karte #25 — HelloFresh nennt es intern Flammkuchen, das gelieferte Produkt ist aber tatsächlich Sauerteig-Pinsateig). Die Anpassung (Step-Reorganisation, Mixtopf-Tomatensoße, Mengen-Konsistenz, Tipps) ist die Eigenarbeit für die Cookidoo-Version.
