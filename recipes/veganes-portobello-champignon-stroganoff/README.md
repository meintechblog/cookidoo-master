...
![Veganes Portobello-Champignon-Stroganoff auf Fusilli mit Kürbiskern-Chili-Topping](hero.jpg)
...
![Public Preview ohne Login](../../docs/assets/stroganoff-public-preview.png)

Die Zubereitung mit den hervorgehobenen Koch-Befehlen:

![Zubereitung mit Chips](../../docs/assets/stroganoff-zubereitung.png)

Tipps + Quellen-Narrativ:

![Tipps mit Narrativ](../../docs/assets/stroganoff-tips.png)
